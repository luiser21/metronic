    ...
    try{		
     ...
     ?>
       ...
       <?php	
         ...
         ?>
            <script language="javascript">           	
            let mensajeError = "<?php echo addslashes('Excepción capturada: ' . $e->getMessage()); ?>";
                     ...
                     <div class="portlet-body form">
                        ...
                        <form action="registrar_testigos.php?add=1" id="form_sample_1" class="form-horizontal" method="post">
                           <div class="alert alert-error hide">
                              ...
                              Usted tiene algunos errores de forma. Por favor , consulte m�s abajo.
                           </div>
                           <div class="alert alert-success hide">
                              <button class="close" data-dismiss="alert"></button>
                             Su validaci�n de formularios es un �xito!
                           </div>
